...
const ScrollExpand: React.FC<ScrollExpandProps> = ({
  ...
  const propsRef = useRef<Required<Pick<ScrollExpandProps, ConfigKey>>>(
    {
      ...
      scrollDistance, holdDistance, smoothing, overlayScrim,
      useWindowScroll, enabled, playOnFullExpand
  ...
  }, [startWidth, startHeight, startRadius, endRadius, mediaZoom, scrollDistance, holdDistance, smoothing, overlayScrim, useWindowScroll, enabled, playOnFullExpand]);
  ...
  const applyProgress = useCallback((p: number) => {
    ...
    if (mediaType === 'video' && c.playOnFullExpand) {
